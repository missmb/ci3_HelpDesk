        ...
        <div class="col-lg-10">
            ...
            <form action="<?= base_url('ticket/edit'); ?>" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <select name="category" id="category" class="form-control col-sm-9">
                        ...
                        <?php foreach ($category as $v) : ?>
                            <option value="<?= $ticket->ID_CATEGORY?>" <?= $v->ID_CATEGORY ?"selected" : null ?>>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-floating row mb-3">
                    ...
                    <textarea class="form-control col-sm-9"  id="detail" name="detail"  <?= $ticket['DETAIL'] ?> ?>" value="<?php $ticket['DETAIL'] ?>" style="height: 100px" ></textarea>
                </div>
